...
def demo_tictactoe_session_json():
    policy = Policy()
    ...
    session = Session(id="demo_session", policy=policy, identity=alice)
    ...
    print("\nSession .get_all_status_json():\n", session.get_all_status_json())
    print("\nSession .get_all_flat_state_json():\n",
          session.get_all_flat_state_json())


if __name__ == "__main__":
    demo_tictactoe_session_json()
